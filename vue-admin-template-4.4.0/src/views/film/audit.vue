    ...
    <div>
            ...
            <el-row>
                <el-col :span="20">
                    <div class="grid-content bg-purple">
                        <!-- <el-input v-model="searchModel.userName" placeholder="视频上传者名称" clearable></el-input>
                        <el-input v-model="searchModel.filmName" placeholder="电影名称" clearable></el-input> -->
        ...
        <el-card>
            ...
            <el-table :data="auditList" stripe style="width: 100%">
                ...
                <el-table-column prop="filmName" label="电影名称" width="350">
                </el-table-column>
                ...
                <el-table-column label="操作" width="100">
                    <template slot-scope="scope">
                        <el-button @click="openEditUI(scope.row.auditId)" type="primary" icon="el-icon-search" :disabled="scope.row.status !== '待审核'"
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            ...
            <el-form :model="auditForm" :rules="rules"> 
            ...
            <el-button type="primary" @click="innerVisible = true">电影信息</el-button>
    ...
    methods: {
        ...
        openEditUI(auditId){
            ...
            auditApi.getAuditById(auditId).then(response =>{
                ...
                filmApi.getFilmById(this.auditForm.filmId).then(response => {
